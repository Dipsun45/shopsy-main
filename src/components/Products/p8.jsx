...
export default function ProductDetail8() {
  const { id } = useParams();
  ...
  const products = {
    1: {
      name: "boAt Stone Ignite Portable Bluetooth Speaker",
      price: 6000,
      oldPrice: 8000,
      rating: 4.7,
      images: [
        "https://media-ik.croma.com/prod/https://media.tatacroma.com/Croma%20Assets/Entertainment/Speakers%20and%20Media%20Players/Images/301439_0_GsdZBqbNG.png"
      ],
      description:
        "Portable Bluetooth speaker with deep bass, long battery, and rugged design.",
      specs: [
        "Bluetooth 5.0",
        "12 Hours Playback",
        "Water Resistant",
  ...
  // ⏱ AUTO HIDE SUBMITTED DATA AFTER 15s
  useEffect(() => {
    if (submittedData) {
  ...
  return (
    <>
      {/* 🔥 MAIN PAGE (BLUR WHEN POPUP OPEN) */}
      <div
        className={`bg-gray-50 dark:bg-gray-900 min-h-screen pt-28 pb-16 px-4 text-black dark:text-white ${
          showPopup ? "blur-sm" : ""
        }`}
      >
