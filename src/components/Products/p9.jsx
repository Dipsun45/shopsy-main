...
export default function ProductDetail9() {
  const { id } = useParams();
  ...
  const products = {
    1: {
      name: "Sony VAIO Touchscreen Desktop",
      price: 45000,
      oldPrice: 60000,
      rating: 4.4,
      images: [
        "https://m.media-amazon.com/images/I/61fJF9KBLEL._AC_UF1000,1000_QL80_.jpg"
      ],
      description:
        "All-in-one desktop with touchscreen display and smooth performance.",
      specs: [
        "Touchscreen Display",
        "Intel Processor",
        "8GB RAM",
