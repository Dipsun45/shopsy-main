...
export default function ProductDetail3() {
  ...
  const products = {
    3: {
      ...
      rating: 4.7,
      images: [
        "https://in.store.asus.com/media/catalog/product/g/6/g614ju_eclps_gry_4zone_rgb_kbd_1_.jpg",
      ],
      description:
        "The ASUS ROG Strix G16 is a high-performance gaming laptop designed for heavy gaming, video editing, and multitasking.",
      specs: [
        "16-inch display (FHD+ / 2.5K)",
  ...
  const product = products[id] || products[3];
