...
export default function ProductDetail2() {
  ...
  const products = {
    1: {
      ...
      rating: 4.5,
      images: [
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThussNtyip2hzuXRY1weMfl_zZxoJejVRJTQ&s"
      ],
      description:
        "The iPhone 17 Pro Max (2025) is Apple’s top flagship phone with a big display, powerful A19 Pro chip, advanced AI (Apple Intelligence), and a pro-level camera system.",
      specs: [
