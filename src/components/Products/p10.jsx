...
export default function ProductDetail10() {
  const { id } = useParams();
  ...
  const products = {
    1: {
      ...
      rating: 4.5,
      images: [
        "https://m.media-amazon.com/images/I/61goypdjAYL.jpg"
      ],
      description:
        "Powerful iPad with A14 chip, vibrant display, and great for work and entertainment.",
      specs: [
        "10.9-inch Display",
        "A14 Bionic Chip",
        "64GB Storage",
