...
export default function ProductDetail5() {
  ...
  const products = {
    1: {
      name: "PS 5 PRO GAMING CONSOLE",
      price: 50000,
      oldPrice: 60000,
      rating: 4.5,
      images: [
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8o9T1Pu0-NeysEVnTkBtY167945KK_soyDQ&s"
      ],
      description:
        "The PS5 Pro is the most powerful console made by Sony. It is designed for high-end gaming, 4K / 8K ultra HD gaming, faster performance & smoother gameplay.",
      specs: [
        "Upgraded GPU (~67% more powerful than PS5)",
        "Up to 45% faster rendering",
        "Advanced ray tracing (2–3x faster lighting effects)"
      ],
    },
  };
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen pt-28 pb-16 px-4 text-black dark:text-white">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* PRODUCT SECTION */}
        <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 grid md:grid-cols-2 gap-10 items-center ${showPopup ? "blur-sm" : ""}`}>
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-md z-50">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl w-[90%] max-w-sm shadow-xl">
